...
func main() {
	...
	// service address IP:PORT of ECHOFILTEREDSERVICE. 
	// This variable gets rewritten from k8s environment variables.
	servAddr := "10.100.81.31:3333" 
	...
	cmd := append([]string{"-A"}, "INPUT", "-p", "tcp", "!", "--dport", "4001", "-j", "NFQUEUE", "--queue-num", "0")
